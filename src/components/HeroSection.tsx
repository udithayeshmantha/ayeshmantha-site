...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen relative flex items-center justify-center pt-16 px-6 overflow-hidden"
    >
      ...
      <div className="max-w-7xl w-full mx-auto z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-6">
        <div className="w-full lg:w-1/2 text-left">
          <p className="text-electric-gold mb-2 font-medium">
            Hello, I'm Udith Ayeshmantha
          </p>
          ...
          <p className="text-xl text-text-secondary mt-6 max-w-xl">
            I design and develop applications that are fast, accessible, and
            built with modern technologies to solve real-world problems.
          </p>
          ...
          <div className="flex space-x-6 mt-10">
            <a
              href="https://www.youtube.com/@Udithayeshmantha"
              className="text-text-secondary hover:text-electric-gold transition-colors"
            >
              <svg
