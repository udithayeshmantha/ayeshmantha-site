...
const projects = [
  {
    ...
    category: "Web Design",
    description: "Modern financial dashboard with data visualization and user management.",
  ...
  },
  {
    ...
    category: "Mobile App",
    description: "Travel planning application with itinerary builder and local recommendations.",
  ...
  },
  {
    ...
    category: "Web Design",
    description: "Complete redesign of an e-commerce platform focused on user experience.",
  ...
  },
  {
    ...
    category: "UX/UI",
    description: "Interface design for a connected home system with intuitive controls.",
  ...
  },
  {
    ...
    category: "Mobile App",
    description: "Health monitoring application with data insights and progress visualization.",
  ...
  },
  {
    ...
    category: "Web Design",
    description: "Dynamic website for a creative studio with interactive elements.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div key={project.id} className="portfolio-card group">
              ...
              <div className={`aspect-video rounded-xl overflow-hidden ${project.image} transition-all duration-500`}>
              ...
              <div className="portfolio-overlay">
                ...
                <div>
                  <span className="text-sm text-electric-blue mb-1 inline-block">{project.category}</span>
                  <h3 className="text-xl font-semibold text-white mb-2">{project.title}</h3>
                  <p className="text-text-secondary text-sm mb-4">{project.description}</p>
                  <a href="#" className="inline-flex items-center text-electric-blue hover:text-white transition-colors gap-2 text-sm">
                    <Eye size={16} />
